...
<!-- Favicons -->
<link href="<? echo base_url('public/admin/assets/img/favicon.png'); ?>" rel="icon">
<link href="<? echo base_url('public/admin/assets/img/apple-touch-icon.png'); ?>" rel="apple-touch-icon">
    ...
    <div class="container">
        ...
        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" novalidate action="pages-register" method="post" >
                <div class="col-12">
                ...
                <div class="col-12">
                    <p class="small mb-0">Already have an account? <a href="admin/pages-login">Log in</a></p>
                </div>
                </form>

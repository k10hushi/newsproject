...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <ul id="category-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <a href="international">
            <i class="bi bi-circle"></i><span>international</span>
        </a>
        </li>
        <li>
        <a href="national">
            <i class="bi bi-circle"></i><span>national</span>
        </a>
        </li>
        <li>
        ...
        <a href="entertainment">
            <i class="bi bi-circle"></i><span>entertainment</span>
        </a>
        </li>
        <li>
    ...
    <ul id="Post-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
        <a href="showpost">
            <i class="bi bi-circle"></i><span>showpost</span>
        </a>
        </li>
</ul>
</li>

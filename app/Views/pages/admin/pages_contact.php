...
<!-- ======= Header ======= -->
<?php echo $this->include('layouts\admin\header'); ?>
<!-- End Header -->

<!-- ======= Sidebar ======= -->
<?php echo $this->include('layouts\admin\sidebar'); ?>
<!-- End Sidebar-->
...
<!-- ======= Footer ======= -->
<?php echo $this->include('layouts\admin\footer'); ?>
<!-- End Footer -->
...
<script src="<?php echo base_url('public/admin/assets/vendor/bootstrap/js/bootstrap.bundle.min.j'); ?>"></script>
